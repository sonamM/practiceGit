...
//				setDefectOID(queryDefectID(projId, tcFormattedID, defName));
	...
	///added by sonam for attatchment 
	
	 public void create(RequestInfo requestInfo) throws DefectException{
	 System.out.println("In the create function");
		log.info("Start - create");
		createInstance();
        ...
        try {
        	System.out.println("request info is not null");
        	System.out.println("before json conert method");
			...
			try {
				createResponse = restApi.create(createRequest);
				System.out.println("create Respone value is "+ createResponse);
			
			} catch (IOException e) {
				System.out.println("IO Exception due to create Response");
				log.error("failed to create new entry, message : " + e.toString() + "RallyInfo -" + rallyInfo);
	        	throw new DefectException("failed to create new entry, message : " + e.toString());
			}
             ...
             if (createResponse.wasSuccessful()) {
                 ...
                 // add a for loop where the screen shot can be collected from the defect///
                 ...
                 System.out.println("attatchment created");

                 // Open file
                 RandomAccessFile myImageFileHandle;
					try {
						myImageFileHandle = new RandomAccessFile(fullImageFile, "r");
						System.out.println("value of myImageFile Handle is:"+ myImageFileHandle);
                    ...
                    //added for original(etaap) workspace      
                     //String workspaceRef = "/workspace/16693935735";
                     
                     // workspace value for new workspace- workspace 2 (etaap)
                   // String workspaceRef = "/workspace/28263825254";
                     
                     //workspace for eagles ihs project  
                    // String workspaceRef = "/workspace/11819890550 ";
                     
                     
                    // workspace for Rally_Integration_Test_QA ihs project  
                    String workspaceRef = "/workspace/15570830865";
                     
                     // First create AttachmentContent from image string
                     JsonObject myAttachmentContent = new JsonObject();
                     //added for workspace support delete it - below line
	...
	private void createInstance() throws DefectException{
		...
		//delete below
		System.out.println("done with create instance");
	}
